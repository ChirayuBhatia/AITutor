...
# It's good practice to check if the keys were found
if not GENAI_API_KEY or not UNSPLASH_API_KEY:
	raise ValueError("API keys for GENAI and UNSPLASH must be set as environment variables.")
